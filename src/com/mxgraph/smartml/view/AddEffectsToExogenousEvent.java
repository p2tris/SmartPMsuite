...
public class AddEffectsToExogenousEvent  extends JWizardDialog {
	...
	public Vector<Vector<String>> att_arguments = H_AddExogenousEvent.attual_argum;  
	
	public AddEffectsToExogenousEvent(){
	...
	public class Step0 extends JWizardPanel {
		...
		public Step0() { 
			...
			atTermName_comboBox = new JComboBox<String>(XMLParser.getAllAtomicTermsName(false));
...
} // CHIUDE LA CLASSE ESTERNA (la outer class)
