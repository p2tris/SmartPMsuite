...
public class AddTask extends JFrame
{
	...
	public H_AddTask _handler = null; 
	...
	private void initComponent() {
		...
		sl_contentPane.putConstraint(SpringLayout.SOUTH, panel_3, -6, SpringLayout.NORTH, btnCrt);
		sl_contentPane.putConstraint(SpringLayout.WEST, btnCrt, 99, SpringLayout.WEST, contentPane);
		sl_contentPane.putConstraint(SpringLayout.SOUTH, btnCrt, 0, SpringLayout.SOUTH, contentPane);
	 ...
	 * vettore di vettore. Ogni vettore interno è della forma: [nome_argomento, tipo_argomento] */
	 ...
	 * vettore di stringhe: ogni stringa è una precondizione. */
	public Vector<String> PreconditionsTask(){
		...
		if(precs_string.isEmpty()){
			...
			if(precs_string.contains("AND")){
				...
				/* Ogni elemento dell'array tokens[] è una precondizione */
	 ...
	 * vettore di stringhe: ogni stringa è un supposed effect. */
	public  Vector<String> SupposedEffectsTask(){
		...
		if(effs_string.contains("AND")){
			...
			/* Ogni elemento dell'array tokens[] è un supposed-effect */
	 ...
	 * vettore di stringhe: ogni stringa è un automatic effect. */
	public  Vector<String> AutomaticEffectsTask(){
		...
		if(effa_string.contains("AND")){
			...
			/* Ogni elemento dell'array tokens[] è un automatic-effect */
			for(int j=0;j<tokens.length;j++){		
