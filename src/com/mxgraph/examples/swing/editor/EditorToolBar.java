...
public class EditorToolBar extends JToolBar
{
	...
	public EditorToolBar(final BasicGraphEditor editor, int orientation)
	{
		...
		sizeCombo.setPreferredSize(new Dimension(65, 25));
		...
		//*****************************************
		ImageIcon deploy_icon = new ImageIcon("images/deploy_icon.png");
		JButton deployButton = new JButton(deploy_icon);
		deployButton.setToolTipText("Deployment of the process and the domain theory");
		...
		ImageIcon play_icon = new ImageIcon("images/play_icon.png");
		JButton runButton = new JButton(play_icon);
		runButton.setToolTipText("Execute the process");
